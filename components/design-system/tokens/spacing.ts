...
export const semanticSpacing = {
  ...
  component: {
    ...
    md: spacing[3],      // 12px - medium internal spacing
    lg: spacing[4],      // 16px - large internal spacing
    xl: spacing[6],      // 24px - extra large internal spacing
  },

  // Layout spacing
  layout: {
    xs: spacing[4],      // 16px - minimum layout spacing
  ...
  interactive: {
    xs: spacing[1],      // 4px - tight touch targets
    sm: spacing[2],      // 8px - small touch targets
    md: spacing[3],      // 12px - medium touch targets
    lg: spacing[4],      // 16px - large touch targets
    xl: spacing[6],      // 24px - extra large touch targets
  },
